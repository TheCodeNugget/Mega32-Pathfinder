/**************************************************************************
 ...
 About:		C++ file For easyAVRv7 LCD Library
...
void LCDCmd(uint8_t cmd) {
	DP = (cmd & 0xf0) | (DP & 0x0f); // Isolate upper half of the port to leave lower half for other purposes
	pulseEnable();
	_delay_us(45);
...
void pulseEnable() { // Pulses Enable Pin to Transmit to LCD
	EP |= (1 << E);
	EP &= ~(1 << E);
}
